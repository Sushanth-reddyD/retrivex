...
class RULEREvaluator(BaseEvaluator):
        ...
        for context_length in self.context_lengths:
            for position in self.needle_positions:
                for needle_type in self.needle_types:
                    ...
                    samples_per_config = max(1, min(10, (self.config.max_samples or 100) // 
                                                   (len(self.context_lengths) * len(self.needle_positions) * len(self.needle_types))))
    ...
    def _fill_template(self, template: str) -> str:
        ...
        fillers = {
            ...
            "market": random.choice(["international", "domestic", "regional", "emerging", "European"]),
            "product": random.choice(["software", "hardware", "cloud", "mobile", "enterprise"]),
            "topic": random.choice(["artificial intelligence", "machine learning", "data analytics", "cybersecurity", "automation"]),
            "field": random.choice(["healthcare", "finance", "education", "manufacturing", "technology"]),
            "institution": random.choice(["Stanford University", "MIT", "Harvard", "Oxford University", "Cambridge"]),
            "finding": random.choice(["this approach", "the methodology", "the algorithm", "the framework", "the system"]),
            "technology": random.choice(["cloud computing", "blockchain", "IoT", "edge computing", "quantum"]),
            "feature1": random.choice(["scalability", "security", "performance", "reliability", "flexibility"]),
            "feature2": random.choice(["integration", "automation", "monitoring", "analytics", "optimization"]),
            "feature3": random.choice(["user experience", "cost efficiency", "maintenance", "support", "deployment"]),
            "location": random.choice(["California", "Texas", "Florida", "New York", "Illinois"]),
            "years": random.choice(["10", "15", "20", "25", "30"]),
            "industry": random.choice(["agriculture", "tourism", "manufacturing", "technology", "healthcare"]),
            "process": random.choice(["quality assurance", "data migration", "system backup", "security audit", "compliance review"]),
            ...
            "settings": random.choice(["configuration", "parameters", "options", "preferences", "policies"]),
            "parameters": random.choice(["security protocols", "access controls", "data retention", "backup schedules", "user permissions"]),
            "outputs": random.choice(["reports", "logs", "metrics", "alerts", "notifications"]),
            "task": random.choice(["data processing", "system maintenance", "user provisioning", "backup restoration", "security scanning"]),
            "role1": random.choice(["manager", "supervisor", "administrator", "director", "coordinator"]),
            "role2": random.choice(["technician", "analyst", "specialist", "engineer", "operator"]),
            "timeframe": random.choice(["2", "3", "5", "7", "10"]),
            "scenario": random.choice(["fire alarm", "security breach", "system failure", "power outage", "natural disaster"]),
            "protocol": random.choice(["emergency response", "incident management", "crisis communication", "evacuation procedure", "safety protocol"]),
            "personnel": random.choice(["security team", "management", "emergency services", "IT support", "facility manager"]),
            "subject": random.choice(["engineering", "marketing", "sales", "operations", "research"]),
            "area": random.choice(["productivity", "quality", "efficiency", "innovation", "collaboration"]),
            "outcome": random.choice(["customer satisfaction", "operational excellence", "cost reduction", "performance", "growth"]),
            "trend": random.choice(["digitization", "automation", "sustainability", "remote work", "data-driven decisions"]),
            "period": random.choice(["decade", "five years", "few years", "coming months", "near future"]),
            "skill": random.choice(["leadership", "project management", "data analysis", "communication", "technical writing"]),
            "topic1": random.choice(["fundamentals", "best practices", "methodologies", "frameworks", "principles"]),
            "topic2": random.choice(["advanced techniques", "case studies", "practical applications", "tools", "strategies"]),
            "topic3": random.choice(["emerging trends", "future directions", "continuous improvement", "innovation", "optimization"]),
            "event": random.choice(["annual", "international", "regional", "virtual", "industry"]),
            "industry": random.choice(["technology", "healthcare", "finance", "manufacturing", "education"]),
            "theme": random.choice(["digital transformation", "innovation", "sustainability", "future trends", "best practices"])
        }
    ...
    def simulate_vector_search(
        ...
        seed_hits = [
            SeedHit(chunk=chunk, similarity_score=sim)
            for sim, chunk in similarities[:k]
        ]
