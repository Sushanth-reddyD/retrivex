...
def main():
    ...
    parser.add_argument(
        "--samples", "-s", type=int, default=30, help="Maximum samples per benchmark (default: 30)"
    )

    parser.add_argument(
        "--no-baselines", action="store_true", help="Skip baseline methods evaluation"
    )

    parser.add_argument(
        "--quick", action="store_true", help="Quick evaluation with reduced samples"
    )
